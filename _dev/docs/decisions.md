...
[`PRINCIPLES.md`](https://github.com/robkuehli/python-project-template/blob/main/_dev/PRINCIPLES.md)
in the repo root.
...
- **Two-tier memory model (private vs team).** Agent memory is split: the
