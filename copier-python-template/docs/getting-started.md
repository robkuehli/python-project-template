...
```bash
# absolute path
copier copy --trust ~/Code-Projects/python-project-template/copier-python-template \
            path/to/new-project

# or relative path
copier copy --trust ../python-project-template/copier-python-template my-project
```
