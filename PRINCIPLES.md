...
The governing principles for this Python project template (`copier-python-template`)
and every project generated from it. Short, prescriptive, **load-bearing** —
every line earns its place.

For the *what* (tools, configs, commands), see
[`copier-python-template/README.md`](copier-python-template/README.md) and
[`docs/reference/tools.md`](copier-python-template/template/docs/reference/tools.md.jinja)
